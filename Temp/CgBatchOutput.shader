...
void main ()
{
  ...
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * texture2D (_LightTexture0, tmpvar_9).w) * 2.0));
  c_i0.w = tmpvar_3;
  c = c_i0;
  c.w = tmpvar_3;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp float atten;
  atten = ((float((xlv_TEXCOORD3.z > 0.0)) * texture2D (_LightTexture0, ((xlv_TEXCOORD3.xy / xlv_TEXCOORD3.w) + 0.5)).w) * texture2D (_LightTextureB0, tmpvar_9).w);
  lowp vec4 c_i0;
...
void main ()
{
  ...
  tmpvar_9 = vec2(dot (xlv_TEXCOORD3, xlv_TEXCOORD3));
  lowp vec4 c_i0;
  c_i0.xyz = ((tmpvar_2 * _LightColor0.xyz) * ((max (0.0, dot (xlv_TEXCOORD1, lightDir)) * (texture2D (_LightTextureB0, tmpvar_9).w * textureCube (_LightTexture0, xlv_TEXCOORD3).w)) * 2.0));
  c_i0.w = tmpvar_3;
  c = c_i0;
  c.w = tmpvar_3;
  gl_FragData[0] = c;
